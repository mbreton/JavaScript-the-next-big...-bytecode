...
function initTypeScriptCompiler() {
    ...
    loadJs();
    $('#tsc-js').on('click', loadJs);
    $("#tsc-oo").on('click', loadFile('examples/oo.ts', 'Modèle <span class="color">orienté objet</span>'));
    $("#tsc-generics").on('click', loadFile('examples/generic.ts', 'Les <span class="color">génériques</span>'));
    $("#tsc-module").on('click', loadFile('examples/module.ts', '<span class="color">Modularisation</span> du code'));
}
